...
**[← README](/README.md)** · [Install](/docs/REPLICATE.md) · [Security](/docs/SECURITY.md) · [Operations](/docs/OPERATIONS.md) · [Hardware](/docs/HARDWARE.md) · [August checklist](/docs/AUGUST-CHECKLIST.md)
...
- **Guardian AI:** `guardian_llm.py` + `prompt_guard.py` + `security_events` — see [SECURITY.md](/docs/SECURITY.md)
...
| [SECURITY.md](/docs/SECURITY.md) | Threat model and production checklist |
| [OPERATIONS.md](/docs/OPERATIONS.md) | Backups, updates, troubleshooting |
